...
LABEL org.label-schema.build-date=$BUILD_DATE \
      ...
      org.label-schema.vcs-url="https://github.com/opsworks/php-fpm_exporter" \
      org.label-schema.vendor="hipages" \
      org.label-schema.version=$VERSION \
      org.label-schema.schema-version="1.0" \
      org.label-schema.docker.cmd="docker run -it --rm -e PHP_FPM_SCRAPE_URI=\"tcp://127.0.0.1:9000/status\" opsworks/php-fpm_exporter"
